...
| <a name="input_resource_collection_enabled"></a> [resource\_collection\_enabled](#input\_resource\_collection\_enabled) | DEPRECATED: Use `extended_resource_collection_enabled` instead.<br/>Historical description: Whether Datadog collects a standard set of resources from your AWS account.<br/>Historical default: `null` | `bool` | `null` | no |
